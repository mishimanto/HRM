...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-6">
      ...
      <div className="relative bg-white/5 backdrop-blur-2xl p-10 rounded-3xl shadow-2xl w-full max-w-lg border border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Name Field */}
          <fieldset className="relative border-2 border-white/10 rounded-xl px-4 pt-3 pb-3 focus-within:border-blue-500/50 transition-all duration-300 bg-white/5 backdrop-blur-sm">
