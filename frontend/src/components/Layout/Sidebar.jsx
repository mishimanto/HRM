...
const getNavigationByRoleId = (roleId) => {
  ...
  const allNavigation = [
    ...
    { name: 'Talent & Lifecycle', href: '/talent', icon: BriefcaseIcon, roles: [1, 2, 3] },
    { name: 'Employee Services', href: '/employee-services', icon: Squares2X2Icon, roles: [1, 2, 3, 4] },
    { name: 'Operations', href: '/operations', icon: Squares2X2Icon, roles: [1, 2, 3] },
    { name: 'Compensation', href: '/compensation', icon: CurrencyDollarIcon, roles: [1, 2] },
    { name: 'Administration', href: '/administration', icon: BuildingOfficeIcon, roles: [1, 2] },
    { name: 'My HR', href: '/my-hr', icon: UsersIcon, roles: [1, 2, 3, 4] },
    { name: 'Documents', href: '/documents', icon: DocumentTextIcon, roles: [1, 2] },
  ];
